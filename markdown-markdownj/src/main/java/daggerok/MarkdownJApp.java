...
class MarkdownConfig {
  ...
  @Bean
  MarkdownToHtmlConverter markdownToHtml(MarkdownProcessor markdownProcessor) {
    return markdownProcessor::markdown;
  }
...
public class MarkdownJApp {
  ...
  public static void main(String[] args) {
    SpringApplication.run(MarkdownJApp.class, args);
  }
}
